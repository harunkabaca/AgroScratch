export const translations = {
  tr: {
    ...
    TOOL_SOIL_SENSOR: '🧪 Toprak Sensörü',
    TOOL_ROTARY: '🔄 Döner Alet',
    LED_WHITE: '⬜ Beyaz',
    LED_RED: '🟥 Kırmızı',
    LED_GREEN: '🟩 Yeşil',
    LED_BLUE: '🟦 Mavi',
    ...
    PIN_LOW: 'KAPALI (0)',
    SEED_TOMATO: '🍅 Domates',
    SEED_CUCUMBER: '🥒 Salatalık',
    SEED_LETTUCE: '🥬 Marul',
    SEED_CARROT: '🥕 Havuç',
    SEED_PEPPER: '🌶 Biber',
    SEED_RADISH: '🌱 Turp',
    SEED_SPINACH: '🥬 Ispanak',
    SEED_BEAN: '🫘 Fasulye',
    SEED_CORN: '🌽 Mısır',
    SEED_STRAWBERRY: '🍓 Çilek',
    SEQ_WATER_ALL: '💦 Tüm Bitkileri Sula',
    SEQ_SEED_ALL: '🌱 Tüm Bahçeyi Ek',
    SEQ_WEED_ALL: '🌿 Tüm Otları Temizle',
    SEQ_PHOTO_ALL: '📸 Tüm Bahçeyi Fotoğrafla',
    SEQ_SOIL_TEST: '🧪 Tam Toprak Analizi',
    INTERVAL_HOURLY: 'Saatlik',
    INTERVAL_DAILY: 'Günlük',
    INTERVAL_WEEKLY: 'Haftalık',
    NOTIFY_LOG: '💻 Sistem Günlüğü',
    NOTIFY_EMAIL: '📧 E-posta',
    NOTIFY_TOAST: '🔔 Bildirim',
    TIME_HOUR: 'saat',
    TIME_MINUTE: 'dakika',
    TIME_DAY: 'gün',
    TIME_MONTH: 'ay',
    AXIS_ALL: 'Tüm Eksenler'
  },
  en: {
    brand: 'AgroScratch',
    ...
    TOOL_SOIL_SENSOR: '🧪 Soil Sensor',
    TOOL_ROTARY: '🔄 Rotary Tool',
    LED_WHITE: '⬜ White',
    LED_RED: '🟥 Red',
    LED_GREEN: '🟩 Green',
    LED_BLUE: '🟦 Blue',
    ...
    PIN_LOW: 'OFF (0)',
    SEED_TOMATO: '🍅 Tomato',
    SEED_CUCUMBER: '🥒 Cucumber',
    SEED_LETTUCE: '🥬 Lettuce',
    SEED_CARROT: '🥕 Carrot',
    SEED_PEPPER: '🌶 Pepper',
    SEED_RADISH: '🌱 Radish',
    SEED_SPINACH: '🥬 Spinach',
    SEED_BEAN: '🫘 Bean',
    SEED_CORN: '🌽 Corn',
    SEED_STRAWBERRY: '🍓 Strawberry',
    SEQ_WATER_ALL: '💦 Water All Plants',
    SEQ_SEED_ALL: '🌱 Plant All Garden',
    SEQ_WEED_ALL: '🌿 Clear All Weeds',
    SEQ_PHOTO_ALL: '📸 Photo All Garden',
    SEQ_SOIL_TEST: '🧪 Full Soil Analysis',
    INTERVAL_HOURLY: 'Hourly',
    INTERVAL_DAILY: 'Daily',
    INTERVAL_WEEKLY: 'Weekly',
    NOTIFY_LOG: '💻 System Log',
    NOTIFY_EMAIL: '📧 Email',
    NOTIFY_TOAST: '🔔 Notification',
    TIME_HOUR: 'hour',
    TIME_MINUTE: 'minute',
    TIME_DAY: 'day',
    TIME_MONTH: 'month',
  ...
  de: {
    ...
    TOOL_SOIL_SENSOR: '🧪 Bodensensor',
    TOOL_ROTARY: '🔄 Rotationswerkzeug',
    LED_WHITE: '⬜ Weiß',
    LED_RED: '🟥 Rot',
    LED_GREEN: '🟩 Grün',
    LED_BLUE: '🟦 Blau',
    ...
    SEED_CARROT: '🥕 Karotte',
    SEED_PEPPER: '🌶 Paprika',
    SEED_RADISH: '🌱 Radieschen',
    SEED_SPINACH: '🥬 Spinat',
    SEED_BEAN: '🫘 Bohne',
    SEED_CORN: '🌽 Mais',
    SEED_STRAWBERRY: '🍓 Erdbeere',
    SEQ_WATER_ALL: '💦 Alle Pflanzen gießen',
    SEQ_SEED_ALL: '🌱 Gesamten Garten bepflanzen',
    SEQ_WEED_ALL: '🌿 Alle Unkräuter entfernen',
    SEQ_PHOTO_ALL: '📸 Gesamten Garten fotografieren',
    SEQ_SOIL_TEST: '🧪 Vollständige Bodenanalyse',
    INTERVAL_HOURLY: 'Stündlich',
    INTERVAL_DAILY: 'Täglich',
    INTERVAL_WEEKLY: 'Wöchentlich',
    NOTIFY_LOG: '💻 Systemprotokoll',
    NOTIFY_EMAIL: '📧 E-Mail',
    NOTIFY_TOAST: '🔔 Benachrichtigung',
    TIME_HOUR: 'Stunde',
    TIME_MINUTE: 'Minute',
    TIME_DAY: 'Tag',
    TIME_MONTH: 'Monat',
    AXIS_ALL: 'Alle Achsen'
  },
};
